...
//        Path shootToHumanPlayerContinued = new Path(shTohPContinued, Math.toRadians(180),
//        false, false);
...
//
//                                //  ----- INTAKE HUMAN PLAYER -----
//                                drivetrain.followPathTimed(shootToHumanPlayer, 150, 1.5, 2.0,
//                                true, ROW_TRANSFER_TIME),
//                                robot.gatherRow(shootToHumanPlayerContinued, 150, 1.5, 2.0,
//                                ROW_TRANSFER_TIME),
//
//                                // ----- SHOOT HUMAN PLAYER -----
//                                robot.shootFAR(humanPlayerToShoot, 150, 1.5, 2.0, ALL_TIME,
//                                SHOOT_TIME),
//
//                                // ----- INTAKE THIRD ROW -----
//                                robot.gatherRow(shootToThirdRow, 150, 1.5, 2.0,
//                                ROW_TRANSFER_TIME),
//
//                                // ----- SHOOT THIRD ROW -----
//                                robot.shootFAR(thirdRowToShoot, 150, 1.5, 2.0, ALL_TIME,
//                                SHOOT_TIME),
//
//                                // ----- GO TO HUMAN PLAYER (COLLECT LINGERING BALLS FROM GATE)
//                                -----
//                                robot.gatherLingeringBalls(shootToLingeringBalls,
//                                lingeringBallsToShoot, 150, ALL_TIME, 15),
//                                robot.gatherLingeringBalls(shootToLingeringBalls,
//                                lingeringBallsToShoot, 150, ALL_TIME, 15),
//                                robot.gatherLingeringBalls(shootToLingeringBalls,
//                                lingeringBallsToShoot, 150, ALL_TIME, 15)
