...
/**
 * A simple class to store parameters for the Low Pass Filter. Right now, it only holds the
 * smoothing factor, but you can add more parameters later if needed.
 */
