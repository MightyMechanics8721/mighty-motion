...
//
//@Config
//@Autonomous(name = "Red Near Testing", group = "ACompetition")
//public class RedNearAutonomousTesting extends LinearOpMode {
...
//    public static double timeOut = 29.5;
//    private double SHOOTER_VELOCITY_NORMAL = 2500;
//    private boolean sillyTrig = false;
//
//    @Override
...
//        double[][] firstRowScore = {{-12, 54}, {-8, 14}};
...
//        Path firstRowShoot = new Path(firstRowScore, Math.toRadians(90), true, false);
//
//        waitForStart();
//
//        looptime.reset();
...
//                                            ), timeOut
//                                    ),
//                                    turret.saveAngleAndCountTimed(this, timeOut),
//                                    drivetrain.updateStaticStateTimed(
//                                            opModeIsActive(),
//                                            timeOut
//                                    ),
...
//                auton.run(packet);
//            } else if (!sillyTrig) {
//                RedTeleOpTest.robotPoseNew = drivetrain.state;
//                RedTeleOpTest.turretAngleNew = turret.getAngle();
//                sillyTrig = true;
//                requestOpModeStop();
//            }
//        }
