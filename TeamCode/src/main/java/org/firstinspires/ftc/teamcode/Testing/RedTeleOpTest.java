...
//
//@Config
//@TeleOp(name = "Red TeleOp Test", group = "123Competition")
...
//    public static SimpleMatrix robotPoseNew = new SimpleMatrix(6, 0);
//    public static double turretAngleNew = 0;
//    Battery battery;
//    Turret turret;
//    Indexer indexer;
//    Intake intake;
...
//                RedTeleOpTest.robotPoseNew.get(0, 0),
//                RedTeleOpTest.robotPoseNew.get(1, 0),
//                Math.toDegrees(RedTeleOpTest.robotPoseNew.get(2, 0))
//        );
//
//
...
//        turret.setInitialAngle(RedTeleOpTest.turretAngleNew);
