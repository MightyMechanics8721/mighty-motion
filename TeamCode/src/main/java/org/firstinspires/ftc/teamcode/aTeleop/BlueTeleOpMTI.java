...
import org.firstinspires.ftc.teamcode.Autonomous.BlueNearMTI;
...
@Config
@TeleOp(name = "Blue TeleOp MTI", group = "111Competition")
public class BlueTeleOpMTI extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        drivetrain.setInitialPose(
                BlueNearMTI.staticRobotState.get(0, 0),
                BlueNearMTI.staticRobotState.get(1, 0),
                Math.toDegrees(BlueNearMTI.staticRobotState.get(2, 0))
        );
        turret.setInitialAngle(BlueNearMTI.staticTurretAngle);
        packet.put("x", BlueNearMTI.staticRobotState.get(0, 0));
        packet.put("y", BlueNearMTI.staticRobotState.get(1, 0));
        packet.put("theta", Math.toDegrees(BlueNearMTI.staticRobotState.get(2, 0)));
        packet.put("turret", BlueNearMTI.staticTurretAngle);
