...
// Kept for reference. An unfinished combined shoot-at-pose action, entirely commented out and
// not wired into any OpMode. Update the imports to the new package layout before enabling it.
//
