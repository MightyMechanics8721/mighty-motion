// Superseded by FarAuto, which covers every alliance and routine from one init menu.
// The routes now live in FarPaths, and FarPathsTest locks them against the waypoints
// this file used. Kept for reference and commented out so it no longer registers on
// the Driver Station.
//
...
//            Actions.runBlocking(
//               new ParallelAction(
//                       turret.autoAimTimed(FieldConstants.turretAimPoint(ALLIANCE), 30),
//                       // Ranges to the turret aim point rather than FieldConstants.shooterRangePoint; kept as
//                       // tuned. Unify with the other routines once re-checked on the field.
