// Superseded by NearAuto, which covers every alliance and routine from one init menu.
// The routes now live in NearPaths, written blue-side and mirrored, and NearPathsTest
// locks them against the waypoints this file used. Kept for reference and commented
// out so it no longer registers on the Driver Station.
//
...
//                                                // Ranges to (-57, +/-57) rather than FieldConstants.shooterRangePoint (-60);
//                                                // kept as tuned. Unify once re-checked on the field.
